...
# path to the file (moved location)
GAZETTEER_FILE = pathlib.Path(r"C:\Users\maxke\atmos_py\Project Folders\Data\2025_Gaz_zcta_national.txt")
...
def main():
    ...
    # read the shapefile back in and display it
